pipeline {
    ...
    //     ECR_REPO = 'my-repo'
    //     IMAGE_TAG = 'latest'
    //     SERVICE_NAME = 'llmops-researcher-'
    // }
        ...
        stage('Clone GitHub Repo') {
            steps {
                script {
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-token', url: 'https://github.com/ujjawalsingh10/ResearchRag.git']])
                }
            }
        }
